...
## Live Link
[View Site](https://guarded-atoll-20616.herokuapp.com/advertisement)
...
1. Cloning the repository:
  ```bash
  https://github.com/PatriciaAnduru/pitch-universe.git
  ```
...
## Known Bugs
* Sign up functionality does not work as expected.
